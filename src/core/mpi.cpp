...
template void Send
( const std::complex<float>* buf, int count, int to, int tag, Comm comm );
template void Send
( const std::complex<double>* buf, int count, int to, int tag, Comm comm );
...
template void ISend
( const std::complex<float>* buf, int count, int to, int tag,
  Comm comm, Request& request );
template void ISend
( const std::complex<double>* buf, int count, int to, int tag,
  Comm comm, Request& request );
...
template void Recv
( std::complex<float>* buf, int count, int from, int tag, Comm comm );
template void Recv
( std::complex<double>* buf, int count, int from, int tag, Comm comm );
...
template<typename R>
void IRecv
( std::complex<R>* buf, int count, int from, int tag,
  Comm comm, Request& request )
{
#ifndef RELEASE
    CallStackEntry entry("mpi::IRecv");
...
template void IRecv
( std::complex<float>* buf, int count, int from, int tag,
  Comm comm, Request& request );
template void IRecv
( std::complex<double>* buf, int count, int from, int tag,
  Comm comm, Request& request );
...
( std::complex<float>* buf, int count, int root, Comm comm );
template void Broadcast
( std::complex<double>* buf, int count, int root, Comm comm );
...
( const byte* sbuf, int sc, byte* rbuf, int rc, Comm comm );
template void AllGather
( const int* sbuf, int sc, int* rbuf, int rc, Comm comm );
template void AllGather
( const float* sbuf, int sc, float* rbuf, int rc, Comm comm );
template void AllGather
( const double* sbuf, int sc, double* rbuf, int rc, Comm comm );
template void AllGather
( const std::complex<float>* sbuf, int sc, std::complex<float>* rbuf, int rc,
  Comm comm );
template void AllGather
( const std::complex<double>* sbuf, int sc, std::complex<double>* rbuf, int rc,
  Comm comm );
...
template void Reduce
( const std::complex<float>* sbuf, std::complex<float>* rbuf, int count,
  Op op, int root, Comm comm );
template void Reduce
( const std::complex<double>* sbuf, std::complex<double>* rbuf, int count,
  Op op, int root, Comm comm );
...
template void Reduce
( std::complex<float>* buf, int count, Op op, int root, Comm comm );
template void Reduce
( std::complex<double>* buf, int count, Op op, int root, Comm comm );
